...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        $("#submitButton").click(function(event) {
            ...
            var feedbacks = JSON.parse(localStorage.getItem("Events") || "[]");
    ...
    function Eventlistpage() {
        ...
        if (feedbacks.length > 0) {
            var data = feedbacks.map(function(feedback, index) {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            fetch('./../Data/graphData.json')
                ...
                .then(function(data) {
                    ...
                    var values = data.map(function(bar) {
                        return bar.value;
                    });
                    console.log(labels);
            ...
            fetch('./../Data/viewChartData.json')
                ...
                .then(function(data) {
                    ...
                    console.log(labels);
                    // Render the bar graph
                    var ctx = document.getElementById('viewChartChart').getContext('2d');
                    if (ctx) {
                        new Chart(ctx, {
                            type: 'doughnut',
                            data: {
